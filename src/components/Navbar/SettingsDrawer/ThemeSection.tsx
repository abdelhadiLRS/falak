...
export const themeIcons = {
  [ThemeType.Dark]: <img src={typeof MoonIcon === 'string' ? MoonIcon : (MoonIcon as any).src} alt="Dark theme" width={20} height={20} />,
  [ThemeType.Light]: <img src={typeof SunIcon === 'string' ? SunIcon : (SunIcon as any).src} alt="Light theme" width={20} height={20} />,
  [ThemeType.Auto]: <img src={typeof AutoIcon === 'string' ? AutoIcon : (AutoIcon as any).src} alt="Auto theme" width={20} height={20} />,
  [ThemeType.Sepia]: <img src={typeof SunsetIcon === 'string' ? SunsetIcon : (SunsetIcon as any).src} alt="Sepia theme" width={20} height={20} />,
};
