...
const MENU_ITEMS = [
  {
    ...
    icon: <img src={typeof IconPerson === 'string' ? IconPerson : (IconPerson as any).src} alt="profile" width={20} height={20} />,
  },
  {
    eventName: 'profile_avatar_my_quran',
    navigationUrl: getMyQuranNavigationUrl(),
    translationKey: 'my-quran',
    icon: <img src={typeof BookmarkFilledIcon === 'string' ? BookmarkFilledIcon : (BookmarkFilledIcon as any).src} alt="bookmark" width={20} height={20} className={styles.bookmarkIcon} />,
  },
  {
    eventName: 'profile_avatar_reading_history',
    navigationUrl: getReadingGoalProgressNavigationUrl(),
    translationKey: 'reading-history',
    icon: <img src={typeof ClockIcon === 'string' ? ClockIcon : (ClockIcon as any).src} alt="clock" width={20} height={20} />,
  },
  {
    eventName: 'profile_avatar_my_courses',
    navigationUrl: getMyCoursesNavigationUrl(),
    translationKey: 'my-learning-plans',
    icon: <img src={typeof ReaderIcon === 'string' ? ReaderIcon : (ReaderIcon as any).src} alt="learning-plan" width={20} height={20} />,
  },
];
    ...
    return (
      <PopoverMenu
        ...
        trigger={
          ...
          >
            <img src={typeof IconPerson === 'string' ? IconPerson : (IconPerson as any).src} alt="profile" width={20} height={20} />
          </Button>
        }
        isOpen={isOpen}
      ...
      >
        ...
        <PopoverMenu.Item
          ...
          icon={<img src={typeof LogoutIcon === 'string' ? LogoutIcon : (LogoutIcon as any).src} alt="logout" width={20} height={20} />}
